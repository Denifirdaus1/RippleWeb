        ...
        <div className="space-y-6">
          ...
          <section>
            <div className="mb-4 flex items-center justify-between gap-4">
              ...
              <Link
                href="/profile/stats"
                className="inline-flex items-center gap-2 rounded-full border border-slate-200 bg-white px-4 py-2 text-sm font-bold text-slate-600 transition hover:border-[#9C5FEC] hover:text-[#9C5FEC]"
              >
                Detail Statistics
